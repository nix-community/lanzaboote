...
use lanzaboote_tool::{signature::{LanzabooteSigner, remote::VerificationResponse}, pe::{lanzaboote_image, StubParameters}};
use log::{debug, trace, warn};
use rouille::{Request, Response, try_or_400};
use thiserror::Error;

use crate::policy::{TrivialPolicy, Policy};
...
impl<S: LanzabooteSigner> Handlers<S> {
    ...
    pub fn sign_stub(&self, req: &Request) -> Response {
        ...
        Response::from_data("application/octet-stream",

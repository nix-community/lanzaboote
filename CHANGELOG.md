...
- Added support for Measured Boot via `systemd-pcrlock`. Refer to the
  [Measured Boot guide](https://nix-community.github.io/lanzaboote/how-to-guides/enable-measured-boot.html)
